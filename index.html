...
<head>
    ...
    <title>Chariz Baco Exercise3</title>
</head>
    ...
    <div class="container">
        ...
        <section>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                // HIDE password
                $tosAccepted = isset($_POST['tos']) ? 'Ok' : 'Not Ok'; // TOS mandatory 
                $reg = $_POST['reg'] ?? '';
...
<!--Third Sections--------->
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                //In this section it displays the data filled
                echo "<h4>Values returned by the form:</h4>";
                echo "<ul>";
